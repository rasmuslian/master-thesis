...
train_loader = DataLoader(train_dataset, batch_size=32, shuffle=True) # shuffle=True is only used for training dataset
...
print(f"Accuracy: {round(score/len(train_dataset), 4)*100}%")
print(f"Random Accuracy: {round(rand_score/len(train_dataset), 4)*100}%")